...
class FredClient:
    ...
    def _write_to_cache(self, series_id: str, observations: List[Dict[str, Any]]):
        ...
        try:
            ...
            for obs in observations:
                # FRED API sometimes returns "." for missing values, skip or store as None
    ...
    async def fetch_series_observations(
        ...
        try:
            ...
            # If all else fails, generate mock data so the app stays functional
    ...
    def _generate_mock_data(
        ...
        # Sector/indicator parameters
        if series_id == "DGS10":
            val = 4.2  # 10Y Yield Base (~4.2%)
            step_days = 1
            drift = -0.0005
            vol = 0.04
        elif series_id == "DGS2":
        ...
        while current_date <= end_date:
            # Skip weekends for Daily Bond Rates and Oil
