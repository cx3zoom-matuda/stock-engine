...
# Static fallback database of Japanese stocks for offline usage using stock-engine's core sectors
...
# Mapping of Yahoo Finance industry strings to subsectors or core sectors of stock-engine
YAHOO_SECTOR_MAP = {
...
class MarketDataClient:
    ...
    def _fetch_yfinance(self, ticker_str: str) -> Optional[Dict[str, Any]]:
        ...
        # Resolve mapped subsector to core sector via SUBSECTOR_TO_SECTOR_MAP
        from .schema import SUBSECTOR_TO_SECTOR_MAP
