...
with tab_blueprint:
    ...
    * **一人の指揮官とAIエージェントの軍隊**:
      ...
      * コードを自ら一行ずつ書くのではない、一人の人間のビジョンの下、並行して自律動作する「4つのAIエージェントシステム」をオーケストレーション（指揮・統率）して構築されています。
...
with tab_logic:
    ...
    **🔄 処理パイプラインの4つのステップ:**
    ...
    | :--- | :--- | :--- |
    | **金利上昇 (RATE_RISING)** | 10年国債利回りが50日単純移動平均(SMA)を上回っている状態 | 利回りと50日SMA의 乖離幅に応じて **1 〜 3** |
